...
const Services = () => {
  ...
  return (
    ...
    >
      <SEO
        title={`${SERVICES_SEO.title} - Soft Synergy Systems`}
      ...
      <PageHero
        ...
        breadcrumbs={SERVICES_HERO.breadcrumb}
      />
      ...
      <Section className="bg-white">
        <Container>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-px bg-carbon-20">
            {TECHNOLOGY_STACK.flatStack.map((tech, idx) => (
              <motion.div
                key={tech.name}
                initial={{ opacity: 0 }}
