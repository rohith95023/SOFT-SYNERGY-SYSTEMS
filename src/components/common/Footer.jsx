        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div>
            <h4 className="text-xs uppercase tracking-widest font-semibold text-carbon-40 mb-6">
              {FOOTER_DATA.columnTitles.company}
            </h4>
          ...
          <div>
            <h4 className="text-xs uppercase tracking-widest font-semibold text-carbon-40 mb-6">
              {FOOTER_DATA.columnTitles.services}
            </h4>
            <ul className="flex flex-col gap-1">
          ...
          <div>
            <h4 className="text-xs uppercase tracking-widest font-semibold text-carbon-40 mb-6">
              {FOOTER_DATA.columnTitles.contact}
            </h4>
        ...
        <div className="border-t border-carbon-90">
          <Container className="py-10">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div>
                <h3 className="text-lg font-light text-white mb-1">{FOOTER_DATA.newsletter.title}</h3>
                <p className="text-sm text-carbon-40">{FOOTER_DATA.newsletter.subtitle}</p>
              </div>
              <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                ...
                >
                  ...
                  {nlStatus === 'loading' ? FOOTER_DATA.newsletter.buttonLoading : nlStatus === 'success' ? FOOTER_DATA.newsletter.buttonSuccess : FOOTER_DATA.newsletter.button}
                </button>
              </form>
            </div>
            {nlMessage && (
